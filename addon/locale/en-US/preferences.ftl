...
pref-login-email = Email
pref-login-password = Password
pref-login-button = Login
pref-logout-button = Logout
pref-login-status = Logged in: { $email }
pref-login-success = Login successful
pref-login-failed = Login failed
pref-login-register = No account? Register
pref-login-required = Please login to your Ente Scholar account in settings
